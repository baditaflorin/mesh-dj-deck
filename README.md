...
**Live → https://baditaflorin.github.io/mesh-dj-deck/**

**Source → https://github.com/baditaflorin/mesh-dj-deck**
...
git clone https://github.com/baditaflorin/mesh-dj-deck
cd mesh-dj-deck
npm install
npm run dev
```
...
- `mesh-dj-deck:signalingUrl`
- `mesh-dj-deck:turnTokenUrl`
- `mesh-dj-deck:iceServers`
- `mesh-dj-deck:room`
